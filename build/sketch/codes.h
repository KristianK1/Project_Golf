#line 1 "c:\\Users\\Kristian\\Documents\\GitHub\\Project_Golf\\Prototype_GSM_GPS_2\\codes.h"
...
String loc_to_link(Location location, int code){
  //code=4;
  String link=Link_field1+big_packet(location.getX(), location.getY(), code);
  return link;
}
