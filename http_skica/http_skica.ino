...
void setup() {
  ...
  SIM.httpParams(SET, "\"URL\",\"https://api.thingspeak.com/update?api_key=PY57W7KMYYBE2MDP&status=http://maps.google.com/maps?q=loc:45.424242,18.424242\"");   // Set URL to www.sim.com
